...
export default function ManagerDashboard() {
  const mockBookings = [
    ...
    { booking_id: 3, dormer_id: 3, full_name: 'Mark Reyes', program: 'BS Business Administration', year_level: '1st Year', room_number: '105', type: 'Single', floor: 1, status: 'rejected', check_in: '2026-05-10', check_out: '2026-08-10', num_months: 3, num_occupants: 1 },
  ];
  const mockRooms = [
